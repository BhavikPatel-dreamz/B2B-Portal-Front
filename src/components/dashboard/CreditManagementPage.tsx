...
const CreditManagementPage = ({ customerId, shop, proxyUrl }: PageProps) => {
    return (
        <div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-[#DDE4FF] p-12 text-center">
                <div className="max-w-md mx-auto">
                    ...
                    <p className="text-gray-600 mb-4">
                        This feature is coming soon to the embedded dashboard. You can access the full credit management features through the main portal.
                    </p>
